...
def load_and_preprocess_data(
    ...
    for line in lines:
        ...
        complete_word = start_token + lower_word + end_token
        
        # add bigrams
        for i in range(len(complete_word)-1):
            bigrams.append((complete_word[i], complete_word[i+1]))
...
def count_bigrams(
    ...
    for bigram in bigrams:
        if bigram[0] in char_to_idx and bigram[1] in char_to_idx:
            idx1 = char_to_idx[bigram[0]]
            idx2 = char_to_idx[bigram[1]]
